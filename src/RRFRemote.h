...
String endpointRRF[] = {"http://rrf.globalis-dev.com:8080/RRFTracker/RRF-today/rrf_tiny.json",
...
const char *choiceThemes[]    = {"ROUGE",  "ROSE", "VIOLET",     "BLEU",  "TURQUOISE", "VERT",  "ORANGE",
                                 "MARRON", "GRIS", "CREPUSCULE", "FORET", "ARDOISE",   "FLORAL"};
